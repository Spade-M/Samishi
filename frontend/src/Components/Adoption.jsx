  ...
  return (
    <div className="flex flex-col items-center bg-gray-100 min-h-screen p-10">
      ...
      <div className="d-flex align-items-center">
        ...
        {/* Feed */}
        <div>
          <h2 className="text-lg font-bold text-center mb-3">Adopt Us 
            <img src={cat2} alt="/"
            style={{
              width: "70px",
            }} 
          ...
          {loading ? (
            ...
            >
              {posts.length === 0 && (
                <p className="text-center text-gray-500">No cats for adoption yet! If You have one contact us!</p>
              )}
              {posts.map((post) => (
                <div
                  key={post.id}
